...
public class GraphData {
    ...
    public static final String[] VERTICES_AI = {"A", "B", "C", "D", "E", "F", "G", "H", "I"};

    public static final Object[][] BFS_AI = {
            {"A", "B"}, {"A", "F"},
            {"B", "C"}, {"B", "I"}, {"B", "G"},
            {"C", "I"}, {"C", "D"},
            {"D", "I"}, {"D", "G"}, {"D", "E"}, {"D", "H"},
    ...
    public static final Integer[] VERTICES_09 = {0, 1, 2, 3, 4, 5, 6, 7};
    ...
    public static final String[] VERTICES_af = {"a", "b", "c", "d", "e", "f"};
    ...
    public static final Object[][] ACyclic = {
            {1, 2},
            {1, 3},
            {0, 1},
            {4, 5},
    ...
    public static final String[] VERTICES_ADDR = {"广州", "珠海", "肇庆", "深圳", "南宁", "佛山", "香港"};
